...
const MOCK_SHOPS: Shop[] = [
  { id: '1', name: 'Global Trade Partners', type: 'B2B', rating: 4.9, location: 'International', image: 'https://picsum.photos/seed/int1/400/200' },
  { id: '2', name: 'Export Import Solutions', type: 'B2B', rating: 4.7, location: 'International', image: 'https://picsum.photos/seed/int2/400/200' },
  { id: '3', name: 'Worldwide Sourcing Hub', type: 'B2B', rating: 4.8, location: 'International', image: 'https://picsum.photos/seed/int3/400/200' },
];

export default function InternationalPage() {
  const [filter, setFilter] = useState<'ALL' | 'B2B' | 'B2C'>('B2B'); // International focus B2B
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="space-y-6 animate-in fade-in duration-500">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <h1 className="text-2xl font-black text-slate-900">Business International</h1>
            ...
            >
              <div className="h-40 relative">
                ...
                <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
                  <div>
                    <span className={`px-2 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest text-white ${shop.type === 'B2B' ? 'bg-blue-600' : 'bg-emerald-600'}`}>
                      {shop.type}
                    </span>
