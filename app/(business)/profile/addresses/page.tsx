...
export default async function ProfileAddressesPage() {
  ...
  return (
    <div className="max-w-shamar-container mx-auto px-4 py-shamar-24">
      ...
      <h1 className="text-shamar-h2 text-gray-900">Adresses</h1>
      <p className="text-shamar-body text-gray-500 mt-1">Adresses sauvegardées de livraison.</p>
      <div className="mt-shamar-24 bg-gray-0 rounded-shamar-md border border-gray-200 p-shamar-24 shadow-shamar-soft">
        <Link href="/settings" className="text-primary-600 font-medium hover:underline text-shamar-body">Gérer les adresses (paramètres) →</Link>
      </div>
    </div>
  );
}
