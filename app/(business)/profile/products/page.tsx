...
export default async function ProfileProductsPage() {
  ...
  return (
    <div className="max-w-shamar-container mx-auto px-4 py-shamar-24">
      ...
      <h1 className="text-shamar-h2 text-gray-900">Mes produits</h1>
      <div className="mt-shamar-24 bg-gray-0 rounded-shamar-md border border-gray-200 p-shamar-24 shadow-shamar-soft">
        <Link href="/dashboard/seller/products" className="text-primary-600 font-medium hover:underline text-shamar-body">Ouvrir mes produits →</Link>
      </div>
    </div>
  );
}
