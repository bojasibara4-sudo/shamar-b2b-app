...
export default async function ProfilePayoutsPage() {
  ...
  return (
    <div className="max-w-shamar-container mx-auto px-4 py-shamar-24">
      ...
      <h1 className="text-shamar-h2 text-gray-900">Retraits</h1>
      <p className="text-shamar-body text-gray-500 mt-1">Mobile Money, Banque, Stripe.</p>
      <div className="mt-shamar-24 bg-gray-0 rounded-shamar-md border border-gray-200 p-shamar-24 shadow-shamar-soft">
        <Link href="/dashboard/seller/payouts" className="text-primary-600 font-medium hover:underline text-shamar-body">Ouvrir les retraits →</Link>
      </div>
    </div>
  );
}
