...
export default async function ProfileCommissionsPage() {
  ...
  return (
    <div className="max-w-shamar-container mx-auto px-4 py-shamar-24">
      ...
      <h1 className="text-shamar-h2 text-gray-900">Commissions</h1>
      <p className="text-shamar-body text-gray-500 mt-1">Frais Shamar, détail par commande.</p>
      <div className="mt-shamar-24 bg-gray-0 rounded-shamar-md border border-gray-200 p-shamar-24 shadow-shamar-soft">
        <Link href="/dashboard/seller/commissions" className="text-primary-600 font-medium hover:underline text-shamar-body">Ouvrir les commissions →</Link>
      </div>
    </div>
  );
}
